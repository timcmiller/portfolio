    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + " icon-keyboard_arrow_left" + '"></div><div class="' + SLIDES_ARROW_NEXT + " icon-keyboard_arrow_right" + '"></div>');
